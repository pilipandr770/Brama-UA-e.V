...
print("Создаю и инициализирую базу данных с полной структурой таблиц...")
...
with app.app_context():
    try:
        ...
        db.create_all()
        print("Созданы таблицы в базе данных")
        ...
        print("\nБаза данных готова к использованию. Теперь вы можете запустить приложение командой:")
        print("flask run --host=0.0.0.0 --port=8080")
